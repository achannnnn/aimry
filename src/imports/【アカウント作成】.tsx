import svgPaths from "./svg-u9rb50ca62";
  ...
  return (
    <div className="relative shrink-0 size-[24px]" data-name="verified">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="verified">
          <mask height="24" id="mask0_5_3326" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="24" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="24" id="Bounding box" width="24" />
          </mask>
          <g mask="url(#mask0_5_3326)">
            <path d={svgPaths.p3cd24f00} fill="var(--fill-0, #3C9095)" id="verified_2" />
          </g>
        </g>
      </svg>
    </div>
...
export default function Component() {
  return (
    <div className="bg-[#f6fdff] overflow-clip relative rounded-[54px] size-full" data-name="【アカウント作成】">
      <Group />
      <Header />
      <Frame10 />
    </div>
