import svgPaths from "./svg-ze7lid83a8";
    ...
    <div className="bg-white relative rounded-[8px] shadow-[0px_1px_4px_0px_#e6f9fd,0px_1px_4px_0px_#e6f9fd] shrink-0 w-full" data-name="Button">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex gap-[6px] items-center justify-center px-[24px] py-[16px] relative w-full">
          <MountainFlag />
          <p className="font-['Hiragino_Kaku_Gothic_Pro:W6',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#3c9095] text-[16px] text-center tracking-[0.016px]">目標を設定</p>
...
export default function Component() {
  return (
    <div className="bg-[#f6fdff] overflow-clip relative rounded-[54px] size-full" data-name="【目標作成】">
      <Group />
      <Header />
      <Frame25 />
    </div>
