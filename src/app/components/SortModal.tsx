...
export default function SortModal({ isOpen, currentSort, onClose, onSortChange }: SortModalProps) {
  ...
  return (
    ...
    >
      <div
        className="bg-white rounded-[16px] w-full max-w-[320px] relative animate-in fade-in zoom-in duration-200"
        ...
        <div className="p-[8px]">
          {sortOptions.map((option) => (
            <button
              ...
              className={`w-full text-left p-[16px] rounded-[8px] font-['Nunito_Sans_7pt_SemiExpanded:Medium','Noto_Sans_JP:Medium',sans-serif] text-[16px] transition-colors ${currentSort === option.value
